function date() {
	...
	document.getElementById('days').innerHTML =
		weekDays[week] + ', ' + months[month] + ' ' + dates[day] + '' + ', ' + year;
}
...
[
	...
	fetch(api)
		...
		.then((data) => {
			...
			div.innerHTML = `<p class="name">${city.toUpperCase()}</p>
			<p>${description}</p>
			<img src="http://openweathermap.org/img/wn/${icon}@2x.png"> <p class="temp">${temperature} ºC</p>`;
			document.querySelector('#divisions-list').appendChild(div);
		});
});
